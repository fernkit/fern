...
void setupUI() {
    ...
    std::cout << "7. No complex signal handling to avoid stack overflow" << std::endl;
    std::cout << "=================================" << std::endl;
}
...
void draw() {
    ...
    // Update status texts based on current selections in draw loop
    // This is safer than using signal callbacks
