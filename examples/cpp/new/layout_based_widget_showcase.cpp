...
void setupUI() {
    ...
    // Title Section
    auto title = Text(Point(0, 0), "Layout-Based Widget Showcase", 3, Colors::White);
    ...
    // auto batteryContainer = std::make_shared<CenterWidget>(0, 0, 200, 150);
    // batteryContainer->add(Column(batteryGroup));
    // centerColumn.push_back(batteryContainer);
    // centerColumn.push_back(SizedBox(0, 20));
    ...
    // auto cpuContainer = std::make_shared<CenterWidget>(0, 0, 200, 150);
    // cpuContainer->add(Column(cpuGroup));
    // centerColumn.push_back(cpuContainer);
    ...
    // auto leftContainer = std::make_shared<PaddingWidget>(0, 0, 300, 500, 20, 20, 20, 20);
    // leftContainer->add(Column(leftColumn));
    
    // auto centerContainer = std::make_shared<PaddingWidget>(0, 0, 300, 500, 20, 20, 20, 20);
    // centerContainer->add(Column(centerColumn));
    
    // auto rightContainer = std::make_shared<PaddingWidget>(0, 0, 300, 500, 20, 20, 20, 20);
    // rightContainer->add(Column(rightColumn));
    ...
    // auto qualityContainer = std::make_shared<PaddingWidget>(0, 0, 220, 130, 15, 15, 15, 15);
    ...
    // auto languageContainer = std::make_shared<PaddingWidget>(0, 0, 220, 130, 15, 15, 15, 15);
    ...
    // // === MAIN CONTAINER ===
    // auto mainContainer = std::make_shared<CenterWidget>(0, 0, screenWidth, screenHeight);
    // mainContainer->add(Column(mainColumn));
